...
public class FireBallSpread_CircleSpread : Skill
{
    ...
    public override void Activate()
    {
        ...
        Shoot(RotateVector(mouseDir, 60));
        Shoot(RotateVector(mouseDir, 90));
        Shoot(RotateVector(mouseDir, 120));
        Shoot(RotateVector(mouseDir, 150));
        Shoot(RotateVector(mouseDir, 180));
